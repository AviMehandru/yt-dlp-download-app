      ...
      <button class="tile" data-key="${esc(v.key)}">
        ...
        <div class="tile-body">
          ...
          <div class="tile-meta">
            ...
            ${v.layout_too_new
              ? `<span class="no" title="This video was archived by a newer pipeline than this app understands (layout v${
                  esc(v.layout_version)}). Some of it may be missing or wrong — update the app.">newer archive format</span>`
              : ""}
          </div>
        </div>
      </button>`;
